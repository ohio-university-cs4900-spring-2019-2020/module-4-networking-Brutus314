...
GLViewNetworking* GLViewNetworking::New(const std::vector< std::string >& args)
{
	GLViewNetworking* glv = new GLViewNetworking(args);
...
GLViewNetworking::GLViewNetworking(const std::vector< std::string >& args) : GLView(args)
{
	//Initialize any member variables that need to be used inside of LoadMap() here.
	//Note: At this point, the Managers are not yet initialized. The Engine initialization
	//occurs immediately after this method returns (see GLViewNetworking::New() for
...
GLViewNetworking::~GLViewNetworking()
{
	//Implicitly calls GLView::~GLView()
}


void GLViewNetworking::updateWorld()
{
...
void GLViewNetworking::onResizeWindow(GLsizei width, GLsizei height)
{
	GLView::onResizeWindow(width, height); //call parent's resize method.
}


void GLViewNetworking::onMouseDown(const SDL_MouseButtonEvent& e)
{
	GLView::onMouseDown(e);
}


void GLViewNetworking::onMouseUp(const SDL_MouseButtonEvent& e)
{
	GLView::onMouseUp(e);
}


void GLViewNetworking::onMouseMove(const SDL_MouseMotionEvent& e)
{
...
void GLViewNetworking::onKeyUp(const SDL_KeyboardEvent& key)
{
	GLView::onKeyUp(key);
}


void Aftr::GLViewNetworking::loadMap()
{
...
void GLViewNetworking::createNetworkingWayPoints()
{
